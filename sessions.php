...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM sessions WHERE id=%s",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO sessions (`session`) VALUES ( %s)",
...
$session = mysqli_query( $conn, $query_session) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
 ...
 <tr>
    ...
    <td colspan="5" valign="top"><img src="mm_spacer.gif" alt="" width="305" height="1" border="0" /><br />
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="329">
        <tr>
          <td width="329" class="pageName">Welcome to Session Module </td>
        </tr>
        ...
        <tr>
          <td class="bodyText"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
            <table width="800" align="center">
              ...
              <tr valign="baseline">
                <td nowrap align="right"><div align="left"><strong>Session</strong>:</div></td>
            ...
            <table width="100%" border="3" cellpadding="3" cellspacing="3">
              <tr>
                <td bgcolor="#000000"><span class="style2"><strong>SESSION</strong></span></td>
                <td bgcolor="#000000">&nbsp;</td>
              </tr>
              <?php do { ?>
                <tr>
                  <td><strong><?php echo $row_session['session']; ?></strong></td>
                  <td><a href="sessions.php?id=<?php echo $row_session['id']; ?>">DELETE</a></td>
                </tr>
                <?php } while ($row_session = mysqli_fetch_assoc($session)); ?>
          </table></td>
        </tr>
      </table>
...
<?php
((mysqli_free_result($session) || (is_object($session) && (get_class($session) == "mysqli_result"))) ? true : false);
?>
