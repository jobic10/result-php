...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="376">
		...
		<tr>
          <td class="bodyText"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td><a href="assess.php?regno=<?php echo $row_students['reg_no'];?>">ASSESS</a></td>
                </tr>
	...
	&nbsp;Hello Dear admin, here is where you enter the student score. Click on any student name and then you click ac==&quot;ASSESS&quot; </div></td>
